...
export class ProfilePage{
    ...
    constructor(public navParams: NavParams, public postsService: PostsProvider, public loadingCtrl: LoadingController, public storage:Storage,
    ...
    countOfHoursLeft(product){
        return Math.round((Date.parse(product.date) - Date.now())/3600000);
    }
    addPost(){
